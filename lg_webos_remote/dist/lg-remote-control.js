...
const ct=t=>(e,o)=>{void 0!==o?o.addInitializer((()=>{customElements.define(t,e)})):customElements.define(t,e)},at="lg-remote-control",lt="lg-remote-control-editor";function dt(t,e){let o=Object.keys(t.entities).filter((o=>t.entities[o].platform===e));const i=/media_player/;return o.filter((t=>i.exec(t)))}const ht=new Map(Object.entries({anthemav:{friendlyName:"Anthem A/V Receivers"},arcam_fmj:{friendlyName:"Arcam FMJ Receivers"},denonavr:{friendlyName:"Denon, Marantz A/V Receivers"},heos:{friendlyName:"Denon heos A/V Receivers"},harman_kardon_avr:{friendlyName:"Harman Kardon AVR"},monoprice:{friendlyName:"Monoprice 6-Zone Amplifier"},onkyo:{friendlyName:"Onkyo A/V Receivers"},sonos:{friendlyName:"Sonos"},pws66i:{friendlyName:"Soundavo WS66i 6-Zone Amplifier"},yamaha:{friendlyName:"Yamaha Network Receivers"}})),ut=[{key:"1",name:"1"},{key:"2",name:"2"},{key:"3",name:"3"},{key:"4",name:"4"},{key:"5",name:"5"},{key:"6",name:"6"},{key:"7",name:"7"},{key:"8",name:"8"},{key:"9",name:"9"},{key:"0",name:"0"},{key:"UP",name:"Up"},{key:"LEFT",name:"Left"},{key:"ENTER",name:"Enter/OK"},{key:"RIGHT",name:"Right"},{key:"BACK",name:"Back"},{key:"DOWN",name:"Down"},{key:"EXIT",name:"Exit"},{key:"RED",name:"Red"},{key:"GREEN",name:"Green"},{key:"YELLOW",name:"Yellow"},{key:"BLUE",name:"Blue"},{key:"HOME",name:"Home"},{key:"CHANNELUP",name:"Channel Up"},{key:"MUTE",name:"Mute"},{key:"INFO",name:"Info"},{key:"CHANNELDOWN",name:"Channel Down"},{key:"PLAY",name:"Play"},{key:"PAUSE",name:"Pause"},{key:"STOP",name:"Stop"},{key:"REWIND",name:"Rewind"},{key:"RECORD",name:"Record"},{key:"FAST_FOWARD",name:"Fast Forward"},{key:"POWER",name:"Power"},{key:"VOLUME_UP",name:"Volume Up"},{key:"VOLUME_DOWN",name:"Volume Down"}];let pt=class extends nt{constructor(){super(...arguments),this._overridesExpanded=!1,this._expandedOverride=null}static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config=t}configChanged(t){const e=Object.assign({},this._config);e[t.target.name.toString()]=t.target.value,this._config=e;const o=new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0});this.dispatchEvent(o)}configChangedBool(t){const e=t.target.name,o="true"===t.target.value,i=Object.assign({},this._config);i[e]=o,this._config=i;const s=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(s)}colorsConfigChanged(t){var e,o;if("HA-ICON"===t.target.tagName){const o=t.target.getAttribute("data-input-name");if(o){const t=this.shadowRoot.querySelector(`[name="${o}"]`);if(t){t.value="";const i=Object.assign({},this._config);i.colors=Object.assign({},null!==(e=i.colors)&&void 0!==e?e:{}),i.colors[o]="",this._config=i;const s=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(s)}}}else{const e=Object.assign({},this._config);e.colors=Object.assign({},null!==(o=e.colors)&&void 0!==o?o:{}),e.colors[t.target.name.toString()]=t.target.value,this._config=e;const i=new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0});this.dispatchEvent(i)}}_erase_av_receiver(){this._config.av_receiver_family="",this.requestUpdate()}dimensionsConfigChanged(t){var e;const o=Object.assign({},this._config);o.dimensions=Object.assign({},null!==(e=o.dimensions)&&void 0!==e?e:{}),"border_width"===t.target.name?o.dimensions[t.target.name]=t.target.value+"px":o.dimensions[t.target.name]=t.target.value,this._config=o;const i=new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0});this.dispatchEvent(i)}getLgTvEntityDropdown(t){let e=dt(this.hass,"webostv"),o=H``;return""!=this._config.tventity&&e.includes(t)||(o=H`<option value="" selected> - - - - </option> `),H`
        ...
        `}getDeviceAVReceiverDropdown(t){const e=[...ht.keys()],o=this._config.av_receiver_family&&""!==this._config.av_receiver_family?"":H`<option value="" selected> - - - - </option>`;return H`
        ...
        <div style="display: flex;width: 40ch;align-items: center;">
         <select
            ...
            @change=${this.configChanged}>
            ${o}
            ${e.map((e=>{const o=ht.get(e);return H`
        ...
        <br />
    `}getMediaPlayerEntityDropdown(t){if(this._config.av_receiver_family){const e=dt(this.hass,t),o=""!==this._config.ampli_entity&&e.includes(t)?"":H`<option value="" selected> - - - - </option>`;return H`
   ...
   `:H``}static get styles(){return r`
        ...
        `}function mt(){return H`<svg version="1.0" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        `}function vt(){return H`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <style type="text/css">
                .st0{fill:var(--remote-text-color);}
              </style>
        ...
        </svg>`}var gt;pt=t([ct(lt)],pt);console.info("%c  LG WebOS Remote Control Card  \n%c  version: vv0.0.0-master  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const bt=window;bt.customCards=bt.customCards||[],bt.customCards.push({type:at,name:"LG WebOS Remote Control Card",preview:!0,description:"Remote control card for LG WebOS TV devices"});let ft=gt=class extends nt{static getConfigElement(){return document.createElement(lt)}static getStubConfig(t){let e=dt(t,"webostv");0==e.length&&(e=Object.keys(t.entities).filter((t=>t.startsWith("media_player."))));const o=e.length>0?e[0]:"media_player.lg_webos_smart_tv";return{type:`custom:${at}`,entity:o}}static get iconMapping(){return{disney:_t(),dazn:mt(),nowtv:H`
        ...
        `,amazon:vt()}}static get properties(){return{hass:{},config:{},_show_inputs:{},_show_sound_output:{},_show_text:{},_show_keypad:{},_show_vol_text:{},volume_value:{type:Number,reflect:!0},output_entity:{type:Number,reflect:!0}}}constructor(){super(),this.homeisLongPress=!1,this._show_inputs=!1,this._show_sound_output=!1,this._show_text=!1,this._show_keypad=!1,this._show_vol_text=!1,this.volume_value=0,this.soundOutput=""}render(){const t=this.hass.states[this.config.entity],e=this.config.color_buttons,o=this.config.dimensions&&this.config.dimensions.border_width?this.config.dimensions.border_width:"1px",i=this.config.dimensions&&this.config.dimensions.scale?this.config.dimensions.scale:1,s=Math.round(260*i)+"px",n=this.config.tv_name_color?this.config.tv_name_color:"var(--primary-text-color)",r=this.config.colors&&this.config.colors.background?this.config.colors.background:"var( --ha-card-background, var(--card-background-color, white) )",c=this.config.colors&&this.config.colors.border?this.config.colors.border:"var(--primary-text-color)",a=this.config.colors&&this.config.colors.buttons?this.config.colors.buttons:"var(--secondary-background-color)",l=this.config.colors&&this.config.colors.text?this.config.colors.text:"var(--primary-text-color)",d=this.config.mac;return!this.config.ampli_entity||"external_arc"!==this.hass.states[this.config.entity].attributes.sound_output&&"external_optical"!==this.hass.states[this.config.entity].attributes.sound_output?(this.volume_value=Math.round(100*this.hass.states[this.config.entity].attributes.volume_level),this.output_entity=this.config.entity):(this.volume_value=Math.round(100*this.hass.states[this.config.ampli_entity].attributes.volume_level*2)/2,this.output_entity=this.config.ampli_entity),H`
            <div class="card">
                <div class="page" style="--remote-button-color: ${a}; --remote-text-color: ${l}; --remote-color: ${r}; --remotewidth: ${s};  --main-border-color: ${c}; --main-border-width: ${o}">
                    ...
                    <div class="grid-container-power"  style="--remotewidth: ${s}">
                        ...
                        ${["off","unavailable"].includes(t.state)?H`
                            <button class="btn ripple" @click=${()=>this._media_player_turn_on(d)}><ha-icon icon="mdi:power" style="color: ${l};"/></button>
                        `:H`
  ...
  `}</button>
                        ...
                        `:H`
                            <div class="grid-container-source">
                                ...
                                <button class="btn_source ripple" @click=${()=>this._select_source("DAZN")}>${mt()}</button>
                            </div>`}
                        <!-- ################################# SOURCE BUTTONS END ################################# -->
